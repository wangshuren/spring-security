 ...
 */
package com.wsr.secruity;

import com.wsr.constants.CS;
import com.wsr.dao.TSysUserAuthDao;
import com.wsr.dao.TSysUserDao;
...
//    private SysUserAuthService sysUserAuthService;
    ...
    @Autowired
    private TSysUserAuthDao SysUserAuthDao;
...
//        }
        ...
        //首先根据登录类型 + 用户名得到 信息
        SysUserAuth auth = SysUserAuthDao.selectByLogin(loginUsernameStr, String.valueOf(identityType), CS.SYS_TYPE.MGR);
        ...
        if(CS.PUB_USABLE != sysUser.getState()){ //状态不合法
            throw new RuntimeException("用户状态不可登录，请联系管理员！");
        }
